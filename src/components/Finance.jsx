      ...
      <html>
        ...
        <body>
          <div class="payslip">
            <div class="header">
              <div>
                <h2>${gymSettings?.gymName ? gymSettings.gymName.toUpperCase() : 'FITGENCORE'}</h2>
                <p>${gymSettings?.address || 'HQ Operations - Colombo, Sri Lanka'}</p>
                <p>Email: ${gymSettings?.email || 'finance@fitgencore.com'} | Tel: ${gymSettings?.phone || '+94 11 234 5678'}</p>
              </div>
            ...
            <div class="details-grid">
              <div>
                <p><strong>Employee ID:</strong> ${payslip.employee_id?.substring(0, 12) || 'N/A'}</p>
                <p><strong>Employee Name:</strong> ${payslip.employee_name || 'Legacy Record'}</p>
                <p><strong>Designation (Role):</strong> ${payslip.employee_role || 'Staff Member'}</p>
              </div>
              <div class="header-right">
                <p><strong>Payroll Period:</strong> ${payslip.period || 'Monthly'}</p>
                <p><strong>Payment Date:</strong> ${payslip.date}</p>
                <p><strong>Payment Mode:</strong> <span style="text-transform: capitalize;">${payslip.payment_method?.replace('_', ' ') || 'Bank wire'}</span></p>
              </div>
            </div>
            ...
            <table>
              ...
              <tbody>
                <tr>
                  <td>Basic Salary</td>
                  <td style="text-align: right;">${basicSalary.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                  <td style="text-align: right;">-</td>
                </tr>
                ${bonusPay > 0 ? `
                  <tr>
                    <td>Performance Bonus / Incentives</td>
                    <td style="text-align: right;">${bonusPay.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                    <td style="text-align: right;">-</td>
                  </tr>
                ` : ''}
                ${overtimePay > 0 ? `
                  <tr>
                    ...
                    <td style="text-align: right;">${overtimePay.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                    <td style="text-align: right;">-</td>
                  </tr>
                ` : ''}
                ${allowancePay > 0 ? `
                  <tr>
                    ...
                    <td style="text-align: right;">${allowancePay.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                    <td style="text-align: right;">-</td>
                  </tr>
                ` : ''}
                ${epfDeduction > 0 ? `
                  <tr>
                    ...
                    <td style="text-align: right;">-</td>
                    <td style="text-align: right;">${epfDeduction.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                  </tr>
                ` : ''}
                ${taxDeduction > 0 ? `
                  <tr>
                    ...
                    <td style="text-align: right;">-</td>
                    <td style="text-align: right;">${taxDeduction.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                  </tr>
                ` : ''}
                ${otherDeductions > 0 ? `
                  <tr>
                    ...
                    <td style="text-align: right;">-</td>
                    <td style="text-align: right;">${otherDeductions.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                  </tr>
                ` : ''}
              </tbody>
            </table>
            ...
            <div class="totals">
              <div class="totals-left">
                ...
                ${payslip.notes ? `<p style="margin-top: 10px;"><strong>Remarks:</strong><br/>${payslip.notes}</p>` : ''}
              </div>
            ...
            <div class="footer">
              <p>Reference: ${payslip.reference || payslip.id}</p>
              <p style="font-size: 0.6rem; color: #cbd5e1; margin-top: 5px;">Generated by Fitgen Core Systems</p>
            </div>
          </div>
        </body>
      </html>
