...
import { 
  ...
  AlertCircle, UploadCloud, Info, Check, Trash
} from 'lucide-react';
...
const Finance = () => {
  ...
  const handleExportPDF = (periodType, customRangeObj = null) => {
    ...
    const htmlContent = `
      ...
      <html>
      <head>
        <title>Financial Statement - Ascend Gym</title>
        <style>
      ...
      <body>
        ...
        <div class="header">
          <div class="gym-name">Ascend Fitness Headquarters</div>
        ...
        <div class="footer">
          <div>Generated by Ascend Gym Management System</div>
  ...
  return (
    <div className="page-container">
      ...
      <div className="tab-menu" style={{ display: 'flex', gap: '0.5rem', marginBottom: '1.5rem', borderBottom: '1px solid var(--border-color)', paddingBottom: '0.75rem' }}>
        {['overview', 'income', 'expenses', 'reports', 'exports'].map((tab) => (
          <button
            key={tab}
