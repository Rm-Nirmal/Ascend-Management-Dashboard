...
const Finance = () => {
  ...
  const handleExportPDF = (periodType, customRangeObj = null) => {
    ...
    const htmlContent = `
      ...
      <html>
      <head>
        <title>Financial Statement - ${gymSettings?.gymName || 'Ascend Gym'}</title>
        <style>
      ...
      <body>
        ...
        <div class="header">
          <div class="gym-name">${gymSettings?.gymName || 'Ascend Fitness Headquarters'}</div>
        ...
        <div class="footer">
          <div>Generated by ${gymSettings?.gymName || 'Ascend Gym'} Management System</div>
