      ...
      <body>
        ...
        <div class="header">
          <div>
            ...
            <div class="gym-info">Tel: ${gymSettings?.phone || '+94 11 234 5678'}</div>
          </div>
          <div class="report-info">
            <h2 class="report-title">RETAIL SALE RECEIPT</h2>
            <div class="report-subtitle">Customer Copy</div>
          </div>
        </div>
        ...
        <div class="summary-grid">
          <div class="summary-col">
            ...
            <div class="summary-subtext">Cashier: ${currentUser?.name || 'System POS'}</div>
          </div>
          <div class="summary-col">
            <div class="summary-label">Receipt Details</div>
            <div class="summary-value">${receiptNo}</div>
            <div class="summary-subtext">Date: ${date} ${time ? `@ ${time}` : ''} &bull; Mode: ${(receipt.payment_method || receipt.paymentMethod || 'cash').toUpperCase()}</div>
          </div>
          <div class="summary-col">
          ...
          <tbody>
            <tr>
              <td>
                ...
                <div style="font-size: 10px; color: #6b7280; margin-top: 3px;">SKU: ${productSku}</div>
              </td>
              <td style="text-align: center;">${quantity}</td>
              <td style="text-align: right;">LKR ${unitPrice.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
              <td style="text-align: right;">LKR ${subtotal.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
            </tr>
          </tbody>
        </table>
            ...
            <table class="totals-table">
              ...
              ${discount > 0 ? `
                <tr style="color: #ef4444;">
                  ...
                  <td style="text-align: right;">-LKR ${discount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                </tr>
              ` : ''}
              ${taxAmount > 0 ? `
                <tr>
                  <td>VAT / Sales Tax:</td>
                  <td style="text-align: right;">LKR ${taxAmount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
                </tr>
              ` : ''}
              <tr class="total-row">
                <td>NET TOTAL PAID:</td>
                <td style="text-align: right;">LKR ${totalAmount.toLocaleString('en-US', { minimumFractionDigits: 2 })}</td>
              </tr>
            </table>
          </div>
        </div>
