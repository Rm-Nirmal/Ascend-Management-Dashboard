...
import { 
  FileText, Download, Printer, BarChart3, AlertTriangle, 
  DollarSign, Activity, Truck, Grid, AlertCircle 
} from 'lucide-react';
  ...
  return (
    <div className="page-container" style={{ animation: 'fadeIn 0.3s ease-out' }}>
      ...
      <div className="printable-show" style={{ display: 'none', flexDirection: 'column', gap: '0.5rem', borderBottom: '2px solid #000', paddingBottom: '1rem', marginBottom: '1.5rem' }}>
        <h2 style={{ fontSize: '1.75rem', fontWeight: 800, textTransform: 'uppercase' }}>Ascend Gym SaaS - Inventory Report</h2>
